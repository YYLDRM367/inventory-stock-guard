...
/** USD with cents — used for stock value across the inventory app. */
export function formatUsd(amount: number, maxFractionDigits = 2) {
  return new Intl.NumberFormat("en-US", {
    style: "currency",
    currency: "USD",
...
/** Compact USD ($1.2k / $3.4M) for tight stat cards. */
