...
export const ui = {
  tr: {
    ...
    authBlurb: "Gerçekçi bir katalog, stok ve konumlarla dolu canlı bir stok panelini açmak üzeresin. Etrafına tıkla — hiçbir şey gerçek değil, hiçbir şey bozulmaz.",
  ...
  en: {
    ...
    authBlurb: "You're about to open a live inventory dashboard, pre-loaded with a realistic catalog, stock and locations. Click around — nothing is real, nothing breaks.",
